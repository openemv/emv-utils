...
enum emv_tal_result_t {
	...
	EMV_TAL_RESULT_PPSE_NOT_SUPPORTED, ///< Proximity Payment System Environment (PPSE) not supported
 ...
 *         failed and that the terminal should terminate the card session. See
